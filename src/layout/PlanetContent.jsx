        ...
        return (
            <div className='planet-card container'>
                <div className='row'>
                    ...
                    <div id={planetId} className='planet-image__container container position-relative col-12 col-lg-6 d-flex align-items-center justify-content-center m-auto'>
                        <img className='planet-image img-fluid mx-auto' src={pageState === 'structure' ? props.images.internal : mainImage} />
